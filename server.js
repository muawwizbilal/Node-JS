...
let users = [
    { name: "muawwiz", id: Math.round(Math.random() *1000) },
    { name: "muaz", id:Math.round(Math.random() *1000) },
    { name: "ibraheem", id: Math.round(Math.random() *1000) },
    { name: "bilal", id: Math.round(Math.random() *1000) },
